...
export default function AddAlumnusModal({ activeUser, onSaveAlumni, setIsAddingAlumnus, triggerToast }) {
  ...
  const [newAlumnus, setNewAlumnus] = useState({
    ...
    program: activeUser.role === 'Department Chairperson' ? (activeUser.program || 'Bachelor of Science in Information Technology') : 'Bachelor of Science in Information Technology',
    yearGraduated: 2026,
    honors: '',
